...
import { InitExpeditionComponent } from './expedition/init-expedition/init-expedition.component';
import { AddItemExpeditionComponent } from './expedition/add-item-expedition/add-item-expedition.component';
...
@NgModule({
  declarations: [
    ...
    InitExpeditionComponent,
    AddItemExpeditionComponent
  ],
  imports: [
    CommonModule,
    MatButtonModule,
